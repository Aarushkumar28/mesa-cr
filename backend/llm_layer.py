...
from backend.line_matcher import attach_valid_lines
import json
...
{merged.get('architecture_snapshot', 'No architecture snapshot available')}
...
Severity: critical, high, medium, low"""
    ...
    try:
        ...
        parsed = merged.get("diff_issues", [])
    return attach_valid_lines(parsed, merged.get("diff_text", ""))
